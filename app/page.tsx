        ...
        <div className="max-w-3xl mx-auto text-center relative">
          <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }} viewport={{ once: true, margin: '-80px' }} className="space-y-8">
            ...
            <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ delay: 0.5 }} viewport={{ once: true }} className="text-lg" style={{ color: '#888888' }}>
              Coming to VS Code Marketplace soon. Join the community to get notified the moment it drops.
            </motion.p>
            {/* Community cards */}
            <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.55, duration: 0.5 }} viewport={{ once: true }} className="grid sm:grid-cols-2 gap-4 pt-2">
              <a href="https://discord.gg/QfgBCvuX4d" target="_blank" rel="noopener noreferrer"
                ...
                onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = 'rgba(88,101,242,0.15)'; (e.currentTarget as HTMLElement).style.borderColor = 'rgba(88,101,242,0.5)' }}
                onMouseLeave={e => { (e.currentTarget as HTMLElement).style.background = 'rgba(88,101,242,0.08)'; (e.currentTarget as HTMLElement).style.borderColor = 'rgba(88,101,242,0.25)' }}
              >
                <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: 'rgba(88,101,242,0.15)' }}>
                ...
                <div>
                  <div className="text-sm font-semibold mb-0.5" style={{ color: '#FFFFFF' }}>Join Discord</div>
                  <div className="text-xs" style={{ color: '#888888' }}>Get notified on launch day</div>
                </div>
                <ArrowRight className="w-4 h-4 ml-auto flex-shrink-0" style={{ color: '#5865F2' }} />
              </a>
              <a href="https://x.com/AgoraIO" target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-4 p-5 rounded-xl text-left transition-all"
              ...
              >
                ...
                <div>
                  <div className="text-sm font-semibold mb-0.5" style={{ color: '#FFFFFF' }}>Follow @AgoraIO on X</div>
                  <div className="text-xs" style={{ color: '#888888' }}>Release announcements & updates</div>
                </div>
                <ArrowRight className="w-4 h-4 ml-auto flex-shrink-0" style={{ color: '#888888' }} />
              </a>
            </motion.div>
            <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.7, duration: 0.5 }} viewport={{ once: true }} className="flex flex-col sm:flex-row gap-4 justify-center pt-2">
            ...
            <div className="flex items-center justify-center gap-5 pt-8 flex-wrap text-xs font-mono tracking-wide" style={{ color: '#555555' }}>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8 items-center">
            ...
            <div className="flex justify-start md:justify-center gap-6 text-sm flex-wrap">
              {[
                ...
                { label: 'Discord', href: 'https://discord.gg/QfgBCvuX4d' },
                { label: 'X / Twitter', href: 'https://x.com/AgoraIO' },
