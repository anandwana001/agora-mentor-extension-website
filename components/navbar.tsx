    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-[68px] flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          {/* Discord */}
          <a href="https://discord.gg/QfgBCvuX4d" target="_blank" rel="noopener noreferrer" title="Join Discord" style={{ color: '#888888' }}
          ...
          {/* X / Twitter */}
          <a href="https://x.com/AgoraIO" target="_blank" rel="noopener noreferrer" title="Follow on X" style={{ color: '#888888' }}
